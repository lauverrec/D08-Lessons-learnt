...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="isAnonymous()">
			...
			<li><a class="fNiv" href="user/edit.do"><spring:message code="master.page.user.register" /></a></li>
			<li><a class="fNiv" href="rendezvous_/list-unregister.do"><spring:message code="master.page.rendezvouss.list" /></a></li>
		</security:authorize>
